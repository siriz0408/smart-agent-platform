-- Migration: Improve search ranking algorithm
-- Date: 2026-02-07
-- Purpose: Enhance ranking with field weighting, exact match boosting, and position-based scoring
--          Task: DIS-005

-- ============================================================================
-- Update search_all_entities function with improved ranking
-- ============================================================================
...
BEGIN
  ...
  document_matches_scored AS (
    SELECT
      id,
      entity_type,
      (base_rank * exact_boost * position_boost * field_weight)::float as text_rank,
      match_type
...
COMMENT ON FUNCTION search_all_entities IS 'Unified keyword search with improved ranking: field weighting, exact match boosting, and position-based scoring. Task: DIS-005';
