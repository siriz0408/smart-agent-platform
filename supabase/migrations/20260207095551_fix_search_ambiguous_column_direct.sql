-- Direct fix for search_all_entities ambiguous column reference
-- Date: 2026-02-07
-- Purpose: Fix "column reference \"entity_type\" is ambiguous" error
--          Apply this directly to Supabase database via SQL Editor or CLI
--
-- This replaces the ORDER BY clause to use CASE expression instead of unqualified updated_at
