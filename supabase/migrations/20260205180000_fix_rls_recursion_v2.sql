...
-- 
-- Note: get_user_tenant_id() function already exists and is SECURITY DEFINER,
-- so we just need to fix the policies to use it.
-- ============================================================================

-- ============================================================================
-- STEP 1: Fix profiles policies - remove circular dependency
-- ============================================================================
...
-- Call with auth.uid() explicitly to avoid overload ambiguity
