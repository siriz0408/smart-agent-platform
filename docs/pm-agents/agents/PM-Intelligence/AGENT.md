...
## 21. Development Method Selection
...
1. Invoke: `/feature-dev [task description]`
2. Follow 7-phase workflow (Discovery → Exploration → Questions → Architecture → Implementation → Review → Summary)
3. Report method chosen in work summary

**How to use `smart-agent-brainstorming`:**
1. Use BEFORE implementation for design validation
2. Ask questions one at a time
3. Present design in 200-300 word sections
4. Get validation before proceeding
5. Save validated design to `docs/plans/`

---

## 22. Pre-Work Checklist
...
4. **Read Your Memory** (Required)
   - Read `docs/pm-agents/agents/PM-Intelligence/MEMORY.md`
...
| `smart-agent-ai-chat` | Reference AI chat patterns | Read `.claude/skills/smart-agent-ai-chat/SKILL.md` |
...
**Your Memory File:** `docs/pm-agents/agents/PM-Intelligence/MEMORY.md`
